...
### 主体部分
主题部分主要为对经典技术的从零实现，旨在带领学习者深度掌握经典工作的实现细节:  
...
### 探索部分
探索部分主要为新颖的**学术作品/生产阶段**的优秀作品进行从零复现，旨在带领学习者深度感知如何从`会做->创新`:

1. 使用细粒度语义元素指导增强的RAG检索方法--CDDRS (ADVEI25)
...
<p align="center">
    <img src="./content/TinyGraphRAG/images/workflow.png" style="width:60%;">
</p>
